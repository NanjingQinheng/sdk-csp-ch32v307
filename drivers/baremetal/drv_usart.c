...
static struct ch32_uart_config *_uart_config = NULL;
...
static long ch32_uart_clk_enable(struct ch32_uart_config *config)
{
    /* uart clock enable */
...
static long ch32_gpio_clk_enable(GPIO_TypeDef *gpiox)
{
...
static long ch32_gpio_configure(struct ch32_uart_config *config)
{
...
static long ch32_configure(struct ch32_uart_config *config)
{
